...
namespace indiKots
{
	class mainApp : IuseApp
	{
		...
		} //--- public void pressAnyKey() end ---//

		public void startMenu(string ProjectName)
		{
			Console.WriteLine(ProjectName);
			Console.WriteLine(" If you wish to continue give any input :) If not, write 'E' or 'e' and press 'Enter' to exit :( ");

		} //--- public void startMenu(string ProjectName) end ---//
		...
		} //--- public void endMenu() end ---//

		public void welcomeMenu(string AppName, string AppDescription)
		{
			Console.Clear();
			Console.WriteLine("\n Welcome to {0} \n", AppName);
		...
		} //--- public void welcomeMenu(string AppName, string AppDescription) end ---//
		...
		} //--- public void mainMenu2() end ---//

		public void createCourseList(List<Course> CourseList)
		{
			do
			{
		...
		} //--- public void createCourseList(List<Course> CourseList) end ---//

		public void createTrainerList(List<Trainer> TrainerList)
		{
			do
			{
		...
		} //--- public void createTrainerList(List<Trainer> TrainerList) end ---//

		public void createStudentList(List<Student> StudentList)
		{
			do
			{
		...
		} //--- public void createStudentList(List<Student> StudentList) end ---//
		...
		} //--- public void createAssignmentList(List<Assignment> AssignmentList) end ---//

		public void synthesizeData(List<Course> CourseList, List<Trainer> TrainerList, List<Student> StudentList, List<Assignment> AssignmentList)
		{
		...
		} //--- public void synthesizeData(List<Course> CourseList, List<Trainer> TrainerList, List<Student> StudentList, List<Assignment> AssignmentList) end ---//

		public void synthesizeCourses(List<Course> CourseList)
		{
		...
		} //--- public void synthesizeCourses(List<Course> CourseList) end ---//

		public void synthesizeTrainers(List<Trainer> TrainerList)
		{
		...
		} //--- public void synthesizeTrainers(List<Trainer> TrainerList) end ---//

		public void synthesizeStudents(List<Student> StudentList)
		{
		...
		} //--- public void synthesizeStudents(List<Student> StudentList) end ---//

		public void synthesizeAssignments(List<Assignment> AssignmentList)
		{
		...
		} //--- public void synthesizeAssignments(List<Assignment> AssignmentList) end ---//
		...
		} //--- public void showCourseList(List<Course> CourseList) end ---//

		public void showTrainerList(List<Trainer> TrainerList)
		{
			Console.WriteLine("\n List of Trainers: \n");
		...
		} //--- public void showTrainerList(List<Trainer> TrainerList) end ---//
		...
		} //--- public void showStudentList(List<Student> StudentList) end ---//

		public void showAssignmentList(List<Assignment> AssignmentList)
		{
			Console.WriteLine("\n List of Assignments: \n");
		...
		} //--- public void showAssignmentList(List<Assignment> AssignmentList) end ---//

		public void showStudentsPerCourse(bool ListObjectFound, List<Course> CourseList, List<Student> StudentList)
		{
		...
		} //--- public void showStudentsPerCourse(bool ListObjectFound, List<Course> CourseList, List<Student> StudentList) end ---//

		public void showTrainersPerCourse(bool ListObjectFound, List<Course> CourseList, List<Trainer> TrainerList)
		{
		...
		} //--- public void showTrainersPerCourse(bool ListObjectFound, List<Course> CourseList, List<Trainer>TrainerList) end ---//

		public void showAssignmentsPerCourse(bool ListObjectFound, List<Assignment> AssignmentList, List<Course> CourseList)
		{
		...
		} //--- public void showAssignmentsPerCourse(bool ListObjectFound, List<Assignment>AssignmentList, List<Course>CourseList) end ---//

		public void showAssignmentsPerStudent(bool ListObjectFound, List<Assignment> AssignmentList, List<Student> StudentList)
		{
		...
		} //--- public void showAssignmentPerStudent(bool ListObjectFound, List<Assignment> AssignmentList, List<Student> StudentList) end ---/
