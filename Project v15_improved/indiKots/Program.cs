...
namespace indiKots
{
	class Program
	{
		...
		} // public static void endMenu() end //

		public static void welcomeMenu(string AppName, string AppDescription)
		{
			Console.Clear();
			Console.WriteLine("\n Welcome to {0} \n", AppName);
		...
		} // public static void welcomeMenu(string AppName, string AppDescription) end //
		...
		} // public static void mainMenu1() end //
		...
		} // public static void mainMenu2() end //

		public static void createCourseList(List<Course> CourseList)
		{
			do
			{
		...
		} // public static void createCourseList(List<Course> CourseList) end //

		public static void createTrainerList(List<Trainer> TrainerList)
		{
			do
			{
		...
		} // public static void createTrainerList(List<Trainer> TrainerList) end //

		public static void createStudentList(List<Student> StudentList)
		{
			do
			{
		...
		} // public static void createStudentList(List<Student> StudentList) end //

		public static void createAssignmentList(List<Assignment> AssignmentList)
		{
			do
			{
		...
		} // public static void createAssignmentList(List<Assignment> AssignmentList) end //

		public static void synthesizeData(List<Course> CourseList, List<Trainer> TrainerList, List<Student> StudentList, List<Assignment> AssignmentList) 
		{
		...
		} // public static void synthesizeData(List<Course> CourseList, List<Trainer> TrainerList, List<Student> StudentList, List<Assignment> AssignmentList) end //

		public static void synthesizeCourses(List<Course> CourseList)
		{
		...
		} // public static void synthesizeCourses(List<Course> CourseList) end //

		public static void synthesizeTrainers(List<Trainer> TrainerList)
		{
		...
		} // public static void synthesizeTrainers(List<Trainer> TrainerList) end //

		public static void synthesizeStudents(List<Student> StudentList)
		{
		...
		} // public static void synthesizeStudents(List<Student> StudentList) end //

		public static void synthesizeAssignments(List<Assignment> AssignmentList)
		{
		...
		} // public static void synthesizeAssignments(List<Assignment> AssignmentList) end //

		public static void showCourseList(List<Course> CourseList)
		{
			Console.WriteLine("\n List of Courses: \n");
		...
		} // public static void showCourseList(List<Course> CourseList) end //

		public static void showTrainerList(List<Trainer> TrainerList)
		{
			Console.WriteLine("\n List of Trainers: \n");
		...
		} // public static void showTrainerList(List<Trainer> TrainerList) end //
		...
		} // public static void showStudentList(List<Student> StudentList) end //

		public static void showAssignmentList(List<Assignment> AssignmentList)
		{
			Console.WriteLine("\n List of Assignments: \n");
		...
		} // public static void showAssignmentList(List<Assignment> AssignmentList) end //

		public static void showStudentsPerCourse(bool ListObjectFound, List<Course> CourseList, List<Student> StudentList)
		{
		...
		} // public static void showStudentsPerCourse(bool ListObjectFound, List<Course> CourseList, List<Student> StudentList) end //

		public static void showTrainersPerCourse(bool ListObjectFound, List<Course> CourseList, List<Trainer> TrainerList)
		{
		...
		} // public static void showTrainersPerCourse(bool ListObjectFound, List<Course> CourseList, List<Trainer>TrainerList) end //

		public static void showAssignmentsPerCourse(bool ListObjectFound, List<Assignment> AssignmentList, List<Course> CourseList)
		{
		...
		} // public static void showAssignmentsPerCourse(bool ListObjectFound, List<Assignment>AssignmentList, List<Course>CourseList) end //

		public static void showAssignmentsPerStudent(bool ListObjectFound, List<Assignment> AssignmentList, List<Student> StudentList)
		{
		...
		}// public static void showAssignmentPerStudent(bool ListObjectFound, List<Assignment> AssignmentList, List<Student> StudentList) end //
